...
class Ahoydtu extends utils.Adapter {
  ...
  async createInverterObjects(inv) {
    ...
    const acStates = [
      ...
      ["temperature", { name: "Inverter temperature", desc: "Internal temperature of the inverter in \xB0C", type: "number", role: "value.temperature", unit: "\xB0C", read: true, write: false, def: 0 }],
